...
The gameplay smoke tests exercise the real combat scripts with a mocked browser environment. They currently cover projectile collisions, airborne melee avoidance, dodge cooldown behavior, melee combo scaling, and wave-clear recovery.
...
- Buffered attacks and three-hit melee chains
- XP, leveling, health pickups and class abilities
- Multi-stage wave encounters with small between-wave recovery
